...
export const { handlers, auth, signIn, signOut } = NextAuth({
                ...
                if (parsedCredentials.success) {
                    ...
                    try {
                        ...
                        return {
                            ...
                            name: decodedToken.username || decodedToken.name || `${decodedToken.firstName} ${decodedToken.lastName}`.trim(),
    ...
    callbacks: {
        ...
        authorized({ auth, request: { nextUrl } }) {
            ...
            const isOnDashboard = nextUrl.pathname === "/dashboard" || nextUrl.pathname.startsWith("/dashboard")
