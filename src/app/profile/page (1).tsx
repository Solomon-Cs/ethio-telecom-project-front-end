        ...
        <SidebarInset className="flex-1 overflow-auto">
          ...
          <main className="p-6 max-w-2xl mx-auto space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="currency" className="flex items-center gap-2">
                    <DollarSign className="h-4 w-4 text-primary" /> Preferred Currency
                  </Label>
                  <Input 
                    id="currency" 
            ...
            <Card className="border-none shadow-sm bg-destructive/5">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">This action is permanent and cannot be undone. All your financial history will be deleted.</p>
