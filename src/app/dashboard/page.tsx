      ...
      <main className='space-y-4 w-full '>
        <section className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
          <div className='space-y-1'>
            <p className='text-lg text-primary underline underline-offset-8'>
              {dayjs(Date.now()).format(' MMM DD, YYYY HH:MM A')}
            </p>
          </div>
        ...
        <div className='grid gap-8  lg:grid-cols-12'>
          <div className='lg:col-span-12 space-y-8'>
            <div className='grid gap-4 md:grid-cols-2'>
              ...
              <div className='space-y-3 bg-white shadow-lg shadow-primary/10 rounded-2xl border border-border/50 p-4'>
